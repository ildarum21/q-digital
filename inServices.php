...
<body>
    <div class="inServ">
        ...
        <div class="container">
            ...
            <div class="descr inServ_descr second ">
                <div class="inServ_descr descr row">
                    Наша преданная команда графических дизайнеров и цифровых дизайнеров оттачивает видение вашего
                    бренда, чтобы разработать эффективный визуальный язык для вашего присутствия в Интернете. Мы
                    разрабатываем высококачественные маркетинговые сайты для амбициозных брендов. Наша преданная
                    команда графических дизайнеров и цифровых дизайнеров оттачивает видение вашего бренда, чтобы
                    разработать эффективный визуальный язык для вашего присутствия в Интернете. Мы разрабатываем
                    высококачественные маркетинговые сайты  для <span class="iServ__unvisibleBlockon320px"> амбициозных брендов. Под разработкой сайтов
                    подразумевается создание:</span>
                </div>
            </div>
            <div class="ul_block">
