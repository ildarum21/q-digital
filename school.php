    ...
    <div class="main schoolmain">
        ...
        <div class="container">
            <div class="main-wrapper">
                <div class="text">
                    <p class="title title_white title_main school "> Курсы от Q-Digital </p>

                    <div class="descr descr_white descr_main school">
                        Освой профессию программиста с нуля или повысь свою
                        квалификацию в сфере IT
                    </div>
                    <a href="#" class=" button button_red main_button school"> Записаться</a>
                </div>

                <img class="main__picture school" src="./public/images/q.png" alt="">
