...
<body>
    <div class="main">
        <div class="container">
            <div class="main-wrapper">
                <div class="text">
                    <p class="title maintitle "> Цифровое </p>
                    <p class="title maintitle "> веб-агентство </p>

                    <div class="descr maindescr">
                        Творческая команда, предоставляющая качественный сервис и эффективные решения для вашего проекта
                    </div>
                    <a href="#" class="button mainbutton "> заполнить бриф</a>
                </div>
        ...
        <div class="container">
            ...
            <div class="listWrapper">
                <div class="advwrapper">
                    <div class="back">
                        <div class="wrapperContent">
                            <div class="field field_title title">Высокая Квалификация</div>

                            <div class="field field_descr descr firts-field">Наши специалисты постоянно</div>
                            <div class="field field_descr descr">развиваются и сдают квалификационные</div>
                            <div class="field field_descr descr">тесты в профильных областях</div>
                ...
                <div class="advwrapper ">
                    <div class="back">
                        <div class="wrapperContent  ">
                            <div class="field field_title title">Всегда на Связи</div>

                            <div class="field field_descr descr firts-field">Наши менеджеры проектов всегда</div>
                            <div class="field field_descr descr">на связи и готовы ответить на ваши</div>
                            <div class="field field_descr descr">вопросы</div>
                            <a class="field field_a  writeMeButton__href">ЗАПОЛНИТЬ БРИФ</a>
                        </div>
                    </div>
                </div>
                <div class="advwrapper ">
                    <div class="back">
                        <div class="wrapperContent ">
                            <div class="field field_title title ">Разумные Цены</div>

                            <div class="field field_descr descr firts-field">Оценка проекта осуществляется </div>
                            <div class="field field_descr descr">только после детального изучения</div>
                            <div class="field field_descr descr">желаний клиента</div>
                            <a class="field field_a  writeMeButton__href">ЗАПОЛНИТЬ БРИФ</a>
                        </div>
                    </div>
                </div>
                <div class="advwrapper ">
                    <div class="back">
                        <div class="wrapperContent ">
                            <div class="field field_title title">Бизнес Направленность</div>
                ...
                <div class="advwrapper ">
                    <div class="back">
                        <div class="wrapperContent">
                            <div class="field field_title title">Гибкий Подход</div>
                            <div class="field field_descr descr firts-field">Для каждой бизнес идеи мы подбираем</div>
                            <div class="field field_descr descr">индивидуальное, наиболее эффективное</div>
                            <div class="field field_descr descr">решение</div>
                            <a class="field field_a  writeMeButton__href">ЗАПОЛНИТЬ БРИФ</a>
                        </div>
                    </div>
                </div>
                <div class="advwrapper ">
                    <div class="back">
                        <div class="wrapperContent  ">
                            <div class="field field_title title">Постоянная Поддержка</div>
                ...
                <div class="advwrapper ">
                    <div class="back">
                        <div class="wrapperContent last">
                            <div class="field field_title title">Качественная Работа</div>
                ...
                <div class="advwrapper ">
                    <div class="back">
                        <div class="wrapperContent last ">
                            <div class="field field_title title">Контроль Сроков</div>
    ...
    <div class="do">
        <div class="container">
            <div class="title dotitle">
                Наши услуги
            </div>
            <div class="descr dodescr">
            ...
            <a href="" class="button dobutton">посмотреть все услуги</a>
        </div>
    </div>
    ...
    <div class="feedback">
        <div class="container center ">
            <div class="feedbacktitle title">
                Отзывы наших клиентов
            </div>
            <div class="feedbackdescr descr">
